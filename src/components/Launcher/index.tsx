...
export default function Launcher() {
  ...
  const launchContext = {
    ...
    pkce: launch.pkce,
    id_token: launch.id_token,
  };

  const launchCode = encode(launchContext);
  ...
  return (
    <HelmetProvider>
      ...
      <div className="container">
                    ...
                    {isStandaloneLaunch || isBackendService ? (
                      ...
                      <a
                        ...
                        onClick={(e) => {
                          if (launch.sim_ehr) {
                            e.preventDefault();
                            console.log(userLaunchUrl?.href ?? "No userlaunchurl");
                            setIframeSrc(userLaunchUrl?.href ?? "");
                          }
                        }}
                      >
                        Launch
                ...
                {validationErrors.filter(
                  ...
                  <a
                    ...
                    onClick={(e) => {
                      if (launch.sim_ehr) {
                        e.preventDefault();
                        setIframeSrc(sampleLaunchUrl.href);
                      }
                    }}
                  >
        ...
        <hr />
        {launch.sim_ehr && <EHR app={iframeSrc} />}
                ...
                <div className="checkbox">
                  <label>
                    <input
                      ...
                      name="sim_sso"
                      value="1"
                      checked={Boolean(launch.id_token)}
                      onChange={(e) =>
                        setQuery({
                          id_token: e.target.checked ? "TEST_ID_TOKEN" : "",
                        })
                      }
                    />{" "}
                    Simulate launch with sso{" "}
                    <span className="text-muted small">
                      (launch using id_token to simulate SSO)
                    </span>
                  </label>
                </div>
              </>
